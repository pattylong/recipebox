...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_recipes(self):
        ...
        # create four posts
        now = datetime.utcnow()
        p1 = Recipe(name="Chocolate chip cookies", user=u1,
                    created_time=now + timedelta(seconds=1))
        p2 = Recipe(name="Kung Pao Chicken", user=u2,
                    created_time=now + timedelta(seconds=4))
        p3 = Recipe(name="Garlic Bread", user=u3,
                    created_time=now + timedelta(seconds=3))
        p4 = Recipe(name="Fried Chicken", user=u4,
                    created_time=now + timedelta(seconds=2))
